...
const EditProfile = ({ navigation, route }) => {
  ...
  const Update_URL =
    "http://ec2-18-222-103-41.us-east-2.compute.amazonaws.com:3000/api/users/update-user";
  const Image_URL =
    "http://ec2-18-222-103-41.us-east-2.compute.amazonaws.com:3000/api/users/post-image";
